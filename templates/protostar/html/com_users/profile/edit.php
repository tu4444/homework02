...
include_once JPATH_ROOT. '/plugins/system/bliss/helper/bliss.php';
...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
	...
	<?php // Iterate through the form fieldsets and display each one. ?>
		...
		<?php
           // $phone=$this->form->getField('phone','profile');
            //echo  $phone->label;
           // echo $phone->input;
		?>
    ...
    <?php foreach ($this->form->getFieldsets() as $group => $fieldset) : ?>
		...
		<fieldset>
			...
			<?php
                //若fieldset為core，field要重新排序
                if($fieldset->name=='core'){
                    $fields=BlissHelper::arrangeDefaultFields($fields);
                }
			?>
